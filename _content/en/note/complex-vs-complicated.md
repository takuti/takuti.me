...
Being complex and complicated are [fundamentally different](https://www.complexsystemsframeworks.ca/framework/complex-versus-complicated/). The former is always unpredictable, dynamic, interdependent, and self-organizing by nature. Numerous factors influence one another, and the output for a given input is probabilistic, if not completely random. There is no fixed rule of saying, "If you do this, that *always* happens."
